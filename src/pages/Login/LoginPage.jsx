            ...
            <div className="space-y-2">
              ...
              <div className="relative group">
                ...
                <input
                  id="usuario"
                  type="text"
                  className={`block w-full pl-11 pr-4 py-3.5 text-slate-900 bg-slate-50 border-2 rounded-xl focus:outline-none focus:bg-white transition-all ${errors.usuario
            ...
            <div className="space-y-2">
              ...
              <div className="relative group">
                ...
                <input
                  ...
                  className={`block w-full pl-11 pr-12 py-3.5 text-slate-900 bg-slate-50 border-2 rounded-xl focus:outline-none focus:bg-white transition-all ${errors.clave
                    ? 'border-red-400 focus:border-red-500 focus:ring-4 focus:ring-red-500/10'
                    : 'border-transparent focus:border-blue-500 focus:ring-4 focus:ring-blue-500/10'
                    }`}
                  placeholder="••••••••"
