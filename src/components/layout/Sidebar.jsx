...
const MENU = [
  ...
  },
  {
    ...
    items: [
      ...
      { to: '/vehiculos', icon: 'fas fa-truck-pickup', label: 'Vehículos', permission: 'administracion.gestion_vehiculos' },
      ...
      { to: '/rutas', icon: 'fas fa-route', label: 'Rutas', permission: 'administracion.gestion_rutas' },
      { to: '/sub-rutas', icon: 'fas fa-code-branch', label: 'Sub-Rutas', permission: 'administracion.gestion_sub_rutas' },
