...
try {
    ...
    $sqlCaja = "SELECT id_caja, fecha_caja, CONCAT(nombre_usuario,' ',apellido_usuario) as cajero,
                ...
                FROM caja, usuario 
                WHERE id_caja = $id_caja AND id_fkusuario_caja = usuario.id_usuario";
    ...
    if (mysqli_num_rows($resultCaja) > 0) {
        ...
        $sqlDetalleCajaIngreso = "SELECT id_caja_detalle, fecha_caja_detalle, tipo_caja_detalle, monto_caja_detalle, observacion_caja_detalle, id_fkcaja, estado_caja_detalle FROM caja_detalle WHERE tipo_caja_detalle='Ingreso' AND id_fkcaja=$id_caja";
        $resultIngresos = mysqli_query($conn, $sqlDetalleCajaIngreso) or die(mysqli_error($conn));
        
        $sqlDetalleCajaEgreso = "SELECT id_caja_detalle, fecha_caja_detalle, tipo_caja_detalle, monto_caja_detalle, observacion_caja_detalle, id_fkcaja, estado_caja_detalle FROM caja_detalle WHERE tipo_caja_detalle='Egreso' AND id_fkcaja=$id_caja";
